...
background-repeat: no-repeat; font-family: 'Montserrat',sans-serif;">
	<div class="wrapper" style="background-image: url(<?=base_url('assets/img/contact-bg.png')?>);background-size: cover;height: 100%;min-height: 100vh;">
		<div style="text-align: center;top: 20%;left: 0;right: 0;position: absolute;padding: 2%;color: #fff;width: 70%;margin: 0 auto;overflow: hidden;background: #2e873eb3;">
			<div style="display: inline-block;color: #f3f3f3;">
				<h2 style="font-size: 8vw;margin: 0;text-transform: uppercase;">Success</h2>
			</div>
			<p style="font-size: 2vw;margin: 0;text-transform: uppercase;line-height: 1;letter-spacing: 2px;">Account successfully verified.</p>
