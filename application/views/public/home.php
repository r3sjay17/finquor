...
<section class="sOne">
	<div class="wrapper">
		<h1>How does FinQuor help you?</h1>
		<div class="row">
			<div class="col item">
...
<section class="sThree" ng-app="appHomeInquiry" ng-controller="homeInquiryCtrl">
	<div class="wrapper">
		...
		<form id="frm-home-inquiry" name="frmHomeInquiry" class="frm-inquiry" novalidate>
			<div class="row">
				<div class="col">
				...
				<div class="col">
					...
					<!-- error message -->
					<p ng-show="frmHomeInquiry.email.$error.pattern" class="error-msg">Please enter a valid email address</p>
				</div>
			</div>
			...
			<div class="row">
				<div class="col">
					...
					<button type="submit" class="btn btn-theme" ng-disabled="frmHomeInquiry.name.$invalid || frmHomeInquiry.email.$invalid">Submit <i class="fa fa-chevron-right"></i></button>
				</div>
			</div>
		</form>
	</div>
...
<script type="text/javascript">
	angular.module('appHomeInquiry', []).controller('homeInquiryCtrl', function() {})
</script>